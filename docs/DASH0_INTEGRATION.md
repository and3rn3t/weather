...
src/
├── utils/
│   └── dash0Setup.ts           # Core Dash0 configuration and telemetry class
├── hooks/
│   └── useDash0Telemetry.ts    # React hooks for telemetry integration
├── examples/
│   └── dash0Integration.tsx    # Example component integrations
└── ...
```
