...
const SunIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const MoonIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const CloudIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const PartlyCloudyDayIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const RainIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const SnowIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const ThunderstormIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
...
const FogIcon: React.FC<{ size: number; animated: boolean }> = ({
  size,
  animated,
}) => (
  <svg
