...
export const useTheme = () => {
  ...
  return {
    ...
    createResponsiveStyle: (property: string, values: {
      mobile: string;
      tablet?: string;
      desktop?: string;
    ...
    createMobileButton: (isPrimary = true, size: 'small' | 'medium' | 'large' = 'medium') =>
    ...
    createMobileGrid: (columns: { mobile: number; tablet?: number; desktop?: number }) =>
