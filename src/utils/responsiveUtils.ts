...
export const createResponsiveTheme = (baseTheme: ThemeColors) => ({
  ...
  responsive: {
    ...
    createMobileButton: (isPrimary = true, size: ButtonSize = 'medium') => ({
      ...
      background: isPrimary ? baseTheme.buttonGradient : baseTheme.toggleBackground,
    ...
    createMobileCard: (isWeatherCard = false) => ({
      ...
      backgroundColor: isWeatherCard ? baseTheme.weatherCardBackground : baseTheme.forecastCardBackground,
