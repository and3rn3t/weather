...
export const useBreakpoint = () => {
  ...
  return {
    ...
    isDesktop: currentBreakpoint === 'desktop' || currentBreakpoint === 'desktopLarge',
...
export const useNetworkAwareLoading = () => {
  ...
  return {
    ...
    isFastConnection: networkInfo.effectiveType === '4g' || networkInfo.downlink > 1.5,
    shouldOptimizeImages: networkInfo.saveData || networkInfo.effectiveType === 'slow-2g' || networkInfo.effectiveType === '2g'
  };
};
...
export const useTouchGestures = () => {
  ...
  return {
    ...touchState,
    handleDoubleTap,
    createSwipeHandler: (onSwipeLeft?: () => void, onSwipeRight?: () => void) => {
      let startX = 0;
      let startY = 0;
