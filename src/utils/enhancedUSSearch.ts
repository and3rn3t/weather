...
export const US_CITIES_DATABASE = [
  ...
  // State Capitals and Regional Hubs (Priority 6)
  {
    name: 'Austin',
    state: 'Texas',
    stateAbbr: 'TX',
  ...
  // More Major Cities (Priority 6-7)
  {
    name: 'Charlotte',
    state: 'North Carolina',
    stateAbbr: 'NC',
  ...
  // Additional Popular Cities (Priority 5-6)
  {
    name: 'Memphis',
    state: 'Tennessee',
    stateAbbr: 'TN',
  ...
  // Popular Smaller Cities and College Towns (Priority 4-5)
  {
    name: 'Ann Arbor',
    state: 'Michigan',
    stateAbbr: 'MI',
  ...
  // Additional Regional Centers (Priority 4-5)
  {
    name: 'Tampa',
    state: 'Florida',
    stateAbbr: 'FL',
  ...
  // More State Capitals (Priority 4-5)
  {
    name: 'Richmond',
    state: 'Virginia',
    stateAbbr: 'VA',
